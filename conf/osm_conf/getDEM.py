...
# Set up a .wgetrc file to store your NASA Earthdata login username and
# password,
...
clip_fp = 'conf/osm_conf/clip.geojson'
clip_gdf = gpd.read_file(clip_fp)

# Download and load the GeoJSON indexing DEM file names.
strm30m_tile_index_fp = 'conf/osm_conf/srtm30m_bounding_boxes.geojson'
os.system(
...
output_dir = "conf/osm_conf/SRTM_DEM"
